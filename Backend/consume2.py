...
con_consume = pika.BlockingConnection(pika.ConnectionParameters('172.26.30.225', 5672, '/', pika.PlainCredentials('findadoc', 'Findadoc!')))
channel_consume = con_consume.channel()
con_publish = pika.BlockingConnection(pika.ConnectionParameters('172.26.30.225', 5672, '/', pika.PlainCredentials('findadoc', 'Findadoc!')))
