...
do
	...
	if [[ "$line" == "succeeded" ]]; then
		...
		if [[ "$ip" == "172.26.169.103" ]];then
			...
			python3 /home/findadoc/IT490/IT490FindADoc/consume.py
		elif [[ "$ip" == "172.26.30.225" ]]; then
			python3 /home/findadoc/IT490/IT490FindADoc/consume2.py #code to start script
		elif [[ "$ip" == "172.26.83.6" ]]; then
			python3 /home/findadoc/IT490/IT490FindADoc/consume3.py
		fi
	else
		echo "Failed  $ipPort" 
	fi
