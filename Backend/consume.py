...
con_consume = pika.BlockingConnection(pika.ConnectionParameters('172.26.115.206', 5672, '/', pika.PlainCredentials('findadoc', 'Findadoc!')))
channel_consume = con_consume.channel()
con_publish = pika.BlockingConnection(pika.ConnectionParameters('172.26.115.206', 5672, '/', pika.PlainCredentials('findadoc', 'Findadoc!')))
