...
do
	...
	if [[ "$line" == "succeeded" ]]; then
		...
		if [[ "$ip" == "172.26.169.103" ]];then
			...
			node /home/findadoc/IT490/IT490FindADoc/frontEnd/consume.js
		elif [[ "$ip" == "172.26.30.225" ]]; then
			node /home/findadoc/IT490/IT490FindADoc/frontEnd/consume2.js #code to start script
		elif [[ "ip" == "172.26.83.6" ]]; then
			node /home/findadoc/IT490/IT490FindADoc/frontEnd/consume3.js
		fi
	else
		echo "Failed  $ipPort" 
	fi
